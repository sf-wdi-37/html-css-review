...
Answer the [questions](https://docs.google.com/document/d/12fzTOLfV_mm23IIw667arhWS6UoZA8QOLFzZaeCf3FI/edit?usp=sharing) assigned to your group and record your responses on the board. Feel free to do some research if you're not sure! Some places to check: [resource.md](resource.md), [WDI fundamentals](http://fundamentals.generalassemb.ly/), or the sites in [More Resources](#more-resources).
